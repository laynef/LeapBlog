...
export const replacements = (allArrayData, count, prop = 'id', lookUpKey = 'thread_id') => {
	...
	return array.reduce((acc, item) => {
		...
		return acc;
	}, { count, array, dictionary: {}, lookUpArray: {} });
};

export const deleteById = (allArrays, id, prop = 'id', lookUpKey = 'thread_id') => {
