...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.declarePublicRoutes = undefined;\n\nvar _values = __webpack_require__(/*! babel-runtime/core-js/object/values */ \"./node_modules/babel-runtime/core-js/object/values.js\");\n\nvar _values2 = _interopRequireDefault(_values);\n\nvar _pages = __webpack_require__(/*! ./pages */ \"./app/publicPages/pages/index.js\");\n\nvar _lodash = __webpack_require__(/*! lodash */ \"lodash\");\n\nvar _utils = __webpack_require__(/*! ../utils */ \"./app/utils/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }\n\nvar declarePublicRoutes = exports.declarePublicRoutes = function declarePublicRoutes() {\n\tvar client = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;\n\treturn [{\n\t\tcomponent: _pages.routes.MasterPage,\n\t\troutes: [{\n\t\t\tpath: '/',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.HomePage\n\t\t},\n\t\t// LEAVE HERE FOR CLI: Page Routes Declaration\n\t\t{\n\t\t\tpath: '/about',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.AboutUsPage\n\t\t}, {\n\t\t\tpath: '/help',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.HelpPage\n\t\t}, {\n\t\t\tpath: '/about/:title',\n\t\t\tcomponent: _pages.routes.DetailAboutUsPage\n\t\t}, {\n\t\t\tpath: '/contact',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.ContactPage\n\t\t}, {\n\t\t\tpath: '/blog',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.BlogPage\n\t\t}, {\n\t\t\tpath: '/blog/:params',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.DetailBlogPage\n\t\t}, {\n\t\t\tpath: '/services',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.ServicePage\n\t\t}, {\n\t\t\tpath: '/what-we-treat',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.TreatmentPage\n\t\t}].concat((0, _values2['default'])(_pages.globals.ServiceInnerPages).map(function (e) {\n\t\t\treturn {\n\t\t\t\tpath: '/services/' + String((0, _lodash.kebabCase)(e.route)),\n\t\t\t\texact: true,\n\t\t\t\tcomponent: e.component\n\t\t\t};\n\t\t})).concat((0, _values2['default'])(_pages.globals.TreatmentInnerPages).map(function (e) {\n\t\t\treturn {\n\t\t\t\tpath: '/what-we-treat/' + String((0, _lodash.kebabCase)(e.route)),\n\t\t\t\texact: true,\n\t\t\t\tcomponent: e.component\n\t\t\t};\n\t\t})).map(function (e) {\n\t\t\tif (!_utils.blackListAnimationRoutes[e.path]) e.component = client ? (0, _utils.AnimationWrapper)(e.component) : e.component;\n\t\t\treturn e;\n\t\t}).concat([{\n\t\t\tpath: '*',\n\t\t\texact: true,\n\t\t\tcomponent: _pages.routes.NotFoundPage\n\t\t}])\n\t}];\n};\n\n//# sourceURL=webpack:///./app/publicPages/routes.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nvar fileNames = exports.fileNames = [\n// Terminal Files\n'about', 'appointment', 'assessment', 'blog', 'creditcard', 'invoice', 'issue', 'message', 'notification', 'progressNote', 'tracking', 'user'];\n\n//# sourceURL=webpack:///./app/redux/utils/methods/files.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _assign = __webpack_require__(/*! babel-runtime/core-js/object/assign */ \"./node_modules/babel-runtime/core-js/object/assign.js\");\n\nvar _assign2 = _interopRequireDefault(_assign);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }\n\nvar fileNames = ['methods', 'dates', 'globals', 'fetch', 'AnimationWrapper', 'AppointmentModal', 'SaveButtonContainer', 'SaveButtonWrapper', 'AppointmentModalWrapper', 'blackListAnimationRoutes', 'appointmentRoutes', 'saveButtonRoutes'];\n\nvar allMethods = fileNames.reduce(function (acc, item) {\n\treturn (0, _assign2['default'])({}, acc, __webpack_require__(\"./app/utils/methods sync recursive ^\\\\.\\\\/.*$\")(\"./\" + String(item)));\n}, {});\n\nexports['default'] = allMethods;\nmodule.exports = exports['default'];\n\n//# sourceURL=webpack:///./app/utils/index.js?");
...
/***/ "./app/utils/methods/appointmentRoutes.js":
/*!************************************************!*\
  !*** ./app/utils/methods/appointmentRoutes.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar dictionary = [\"/\" + String(\"on\") + \"/dashboard\", \"/\" + String(\"on\") + \"/appointments/:id\", \"/\" + String(\"on\") + \"/clients\", \"/\" + String(\"on\") + \"/scheduler\", \"/\" + String(\"on\") + \"/preview/:full_name\"].reduce(function (acc, item) {\n    acc[item] = item;\n    return acc;\n}, {});\n\nvar appointmentRoutes = exports.appointmentRoutes = dictionary;\n\n//# sourceURL=webpack:///./app/utils/methods/appointmentRoutes.js?");
...
/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/lib/Constants.js":
/*!********************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/lib/Constants.js ***!
  \********************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nmodule.exports = {\n  MODE_DATE: 'date',\n  MODE_MONTH: 'month',\n  MODE_DATETIME: 'datetime',\n  MODE_TIME: 'time',\n\n  SIZE_SMALL: 'sm',\n  SIZE_MEDIUM: 'md',\n  SIZE_LARGE: 'lg'\n};\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/lib/Constants.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/lib/DateTimeField.js":
/*!************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/lib/DateTimeField.js ***!
  \************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/assign */ \"./node_modules/core-js/library/fn/object/assign.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/assign.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/create.js":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/create.js ***!
  \*******************************************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/create */ \"./node_modules/core-js/library/fn/object/create.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/create.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/define-property.js":
/*!****************************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/define-property.js ***!
  \****************************************************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/define-property */ \"./node_modules/core-js/library/fn/object/define-property.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/define-property.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/get-own-property-descriptor.js":
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/get-own-property-descriptor.js ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/get-own-property-descriptor */ \"./node_modules/core-js/library/fn/object/get-own-property-descriptor.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/get-own-property-descriptor.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/keys.js":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/keys.js ***!
  \*****************************************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/keys */ \"./node_modules/core-js/library/fn/object/keys.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/keys.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/set-prototype-of.js":
/*!*****************************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/set-prototype-of.js ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
...
eval("module.exports = { \"default\": __webpack_require__(/*! core-js/library/fn/object/set-prototype-of */ \"./node_modules/core-js/library/fn/object/set-prototype-of.js\"), __esModule: true };\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/set-prototype-of.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/class-call-check.js":
/*!**********************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/class-call-check.js ***!
  \**********************************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nexports[\"default\"] = function (instance, Constructor) {\n  if (!(instance instanceof Constructor)) {\n    throw new TypeError(\"Cannot call a class as a function\");\n  }\n};\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/class-call-check.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/create-class.js":
/*!******************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/create-class.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _Object$defineProperty = __webpack_require__(/*! babel-runtime/core-js/object/define-property */ \"./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/define-property.js\")[\"default\"];\n\nexports[\"default\"] = (function () {\n  function defineProperties(target, props) {\n    for (var i = 0; i < props.length; i++) {\n      var descriptor = props[i];\n      descriptor.enumerable = descriptor.enumerable || false;\n      descriptor.configurable = true;\n      if (\"value\" in descriptor) descriptor.writable = true;\n\n      _Object$defineProperty(target, descriptor.key, descriptor);\n    }\n  }\n\n  return function (Constructor, protoProps, staticProps) {\n    if (protoProps) defineProperties(Constructor.prototype, protoProps);\n    if (staticProps) defineProperties(Constructor, staticProps);\n    return Constructor;\n  };\n})();\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/create-class.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/extends.js":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/extends.js ***!
  \*************************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _Object$assign = __webpack_require__(/*! babel-runtime/core-js/object/assign */ \"./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/assign.js\")[\"default\"];\n\nexports[\"default\"] = _Object$assign || function (target) {\n  for (var i = 1; i < arguments.length; i++) {\n    var source = arguments[i];\n\n    for (var key in source) {\n      if (Object.prototype.hasOwnProperty.call(source, key)) {\n        target[key] = source[key];\n      }\n    }\n  }\n\n  return target;\n};\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/extends.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/get.js":
/*!*********************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/get.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _Object$getOwnPropertyDescriptor = __webpack_require__(/*! babel-runtime/core-js/object/get-own-property-descriptor */ \"./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/get-own-property-descriptor.js\")[\"default\"];\n\nexports[\"default\"] = function get(_x, _x2, _x3) {\n  var _again = true;\n\n  _function: while (_again) {\n    var object = _x,\n        property = _x2,\n        receiver = _x3;\n    _again = false;\n    if (object === null) object = Function.prototype;\n\n    var desc = _Object$getOwnPropertyDescriptor(object, property);\n\n    if (desc === undefined) {\n      var parent = Object.getPrototypeOf(object);\n\n      if (parent === null) {\n        return undefined;\n      } else {\n        _x = parent;\n        _x2 = property;\n        _x3 = receiver;\n        _again = true;\n        desc = parent = undefined;\n        continue _function;\n      }\n    } else if (\"value\" in desc) {\n      return desc.value;\n    } else {\n      var getter = desc.get;\n\n      if (getter === undefined) {\n        return undefined;\n      }\n\n      return getter.call(receiver);\n    }\n  }\n};\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/get.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/inherits.js":
/*!**************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/inherits.js ***!
  \**************************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _Object$create = __webpack_require__(/*! babel-runtime/core-js/object/create */ \"./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/create.js\")[\"default\"];\n\nvar _Object$setPrototypeOf = __webpack_require__(/*! babel-runtime/core-js/object/set-prototype-of */ \"./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/core-js/object/set-prototype-of.js\")[\"default\"];\n\nexports[\"default\"] = function (subClass, superClass) {\n  if (typeof superClass !== \"function\" && superClass !== null) {\n    throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass);\n  }\n\n  subClass.prototype = _Object$create(superClass && superClass.prototype, {\n    constructor: {\n      value: subClass,\n      enumerable: false,\n      writable: true,\n      configurable: true\n    }\n  });\n  if (superClass) _Object$setPrototypeOf ? _Object$setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;\n};\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/inherits.js?");

/***/ }),

/***/ "./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/interop-require-default.js":
/*!*****************************************************************************************************************************!*\
  !*** ./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/interop-require-default.js ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nexports[\"default\"] = function (obj) {\n  return obj && obj.__esModule ? obj : {\n    \"default\": obj\n  };\n};\n\nexports.__esModule = true;\n\n//# sourceURL=webpack:///./node_modules/@starbird/react-bootstrap-datetimepicker/node_modules/babel-runtime/helpers/interop-require-default.js?");
